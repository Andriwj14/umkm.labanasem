        ...
        <div class="row">
				...
				<div class="col-md-6 py-5 px-5">
					...
					<div class="form-group">
						...
						<label class="col-md-12 text-justify mb-3" style="font-size:12pt;" for="name">Jika anda belum memiliki akun, anda dapat <a href="http://umkm.labanasem.id/register.php" target="_blank" class="text-success">Registrasi</a> disini !</label>
						
						<label class="col-md-12" style="font-size:11pt; font-weight:bold;" for="name">Email</label>
						<div class="col-md-12">
							<input type="text" id="useradmin" class="form-control" maxlength="50" name="useradmin" placeholder="Masukkan Email Anda">
						</div>
					</div>	
					<div class="form-group">
						<label class="col-md-12" style="font-size:11pt; font-weight:bold;" for="content">Password</label>
						<div class="col-md-12">
							<input type="password" id="passwordadmin" class="form-control" maxlength="50" name="passwordadmin" placeholder="Masukkan Password Anda">
						</div>
					</div>		
					<div class="form-group">
