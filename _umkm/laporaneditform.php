		...
		<form method="post" action="newseditcontrol.php" enctype="multipart/form-data">
			<div class="col-md-12 col-md-offset-2 custyle">
				...
				<label class="col-md-12 control-label" for="name">Judul</label>
					<div class="col-md-12">
						<input id="frm_subject" required name="frm_subject" maxlength="1000" value="<?php echo $fsubject; ?>" type="text" placeholder="Judul Berita" class="form-control">
					</div>
				</div>
				<div class="form-group">
					<label class="col-md-12 control-label" for="content">Isi Pendek</label>
					<div class="col-md-12">
						<textarea rows="5" maxlength="300" name="frm_short" cols="100"  placeholder="Isi Pendek" class="form-control"><?php echo $fsdesc; ?></textarea>
					</div>
				</div>
				<div class="form-group">
